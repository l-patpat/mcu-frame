...
#define CMD_RD_RX_PLOAD     0x61  //读RX有效数据,1~32字节
#define CMD_WR_TX_PLOAD     0xA0  //写TX有效数据,1~32字节
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线
#define NRF24L01_CEH()	SET_IO(GPIOA, BIT(4))
#define NRF24L01_CEL()	CLEAR_IO(GPIOA, BIT(4))
#define NRF24L01_CSH()	SET_IO(GPIOC, BIT(4))
#define NRF24L01_CSL()	CLEAR_IO(GPIOC, BIT(4))
#define NRF24L01_IRQ()	READ_IO(GPIOC, BIT(5))
//24L01发送接收数据宽度定义
...
unsigned char NRF24L01_Write_Buf(unsigned char reg, unsigned char *pBuf, unsigned char len);//写数据区
unsigned char NRF24L01_Read_Buf(unsigned char reg, unsigned char *pBuf, unsigned char len);//读数据区		  
