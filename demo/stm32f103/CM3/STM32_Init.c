...
#define __RCC_CR_VAL               0x01010083
...
//                     <0=> SYSTICKCLK = HCLK/8
//                     <1=> SYSTICKCLK = HCLK
//   <o2> System Timer reload value [tick] <1-16777215:1000>
//   <i> Set the timer ticks for System Timer.
//   <i> Default: 1000 [tick]
//   <o1.1> System Timer interrupt enabled
// </e>
#define __SYSTICK_SETUP           1
#define __SYSTICK_CTRL_VAL        0x00000006
#define __SYSTICK_TICKS	          0x00044AA2
...
#define __GPIOA_CRL               0xB4B34344
#define __GPIOA_CRH               0x444448B4
#define __GPIOB_CRL               0x44444433
#define __GPIOB_CRH               0xB4B44444
#define __GPIOC_CRL               0x44834444
#define __GPIOC_CRH               0x44444444
#define __GPIOD_CRL               0x44444444
#define __GPIOD_CRH               0x44444443
...
#if ((__SYSTICK_TICKS) > 0xFFFFFF)		// reload value to large
   #error "Reload Value to large!"
#else
  SysTick->LOAD  = (__SYSTICK_TICKS & 0xFFFFFF) - 1;      // set reload register
  SysTick->CTRL  = __SYSTICK_CTRL_VAL;                          // set clock source and Interrupt enable

  SysTick->VAL   =  0;                                          // clear  the counter
  SysTick->CTRL |= SysTick_CTRL_ENABLE;                          // enable the counter
#endif
...
void STM32_TamperSetup (void) {
  ...
  if (BKP->CSR & (1<<2)) {                                  // Tamper interrupt enable ?
    NVIC->ISER[0] |= (1 << (TAMPER_IRQn & 0x1F));   // enable interrupt
  }
